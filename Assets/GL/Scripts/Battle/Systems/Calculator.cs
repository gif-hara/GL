...
namespace GL.Scripts.Battle.Systems
{
    ...
    public static class Calculator
    {
        ...
        {
            var baseStrength = Mathf.Pow(invoker.BaseStatus.Strength, 2) * rate;
            var baseDefense = Mathf.Pow(target.BaseStatus.Defense, 2);
        ...
        {
            return invoker.BaseStatus.Sympathy / 2;
        }
    }
}
